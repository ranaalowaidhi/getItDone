...
class ShoppingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        taskRecyclerView = view.findViewById(R.id.shopping_task_rcv)
    ...
    private inner class TaskAdapter(var tasks:List<Task>):
        RecyclerView.Adapter<ShoppingFragment.TaskViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShoppingFragment.TaskViewHolder {
            val view = layoutInflater.inflate(R.layout.home_task_item, parent,false)
            return TaskViewHolder(view)
        }

        override fun onBindViewHolder(holder: ShoppingFragment.TaskViewHolder, position: Int) {
