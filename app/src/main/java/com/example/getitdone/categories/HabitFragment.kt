...
class HabitFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        taskRecyclerView = view.findViewById(R.id.habit_task_rcv)
    ...
    private inner class TaskAdapter(var tasks:List<Task>):
        RecyclerView.Adapter<HabitFragment.TaskViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HabitFragment.TaskViewHolder {
            val view = layoutInflater.inflate(R.layout.home_task_item, parent,false)
            return TaskViewHolder(view)
        }

        override fun onBindViewHolder(holder: HabitFragment.TaskViewHolder, position: Int) {
