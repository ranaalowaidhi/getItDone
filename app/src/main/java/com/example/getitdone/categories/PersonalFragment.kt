...
class PersonalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        taskRecyclerView = view.findViewById(R.id.personal_task_rcv)
    ...
    private inner class TaskAdapter(var tasks:List<Task>):
        RecyclerView.Adapter<PersonalFragment.TaskViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PersonalFragment.TaskViewHolder {
            val view = layoutInflater.inflate(R.layout.home_task_item, parent,false)
            return TaskViewHolder(view)
        }

        override fun onBindViewHolder(holder: PersonalFragment.TaskViewHolder, position: Int) {
